...
import (
	...
	myresourcev1 "github.com/yaamai/mutation/pkg/apis/myresource/v1"
	versioned "github.com/yaamai/mutation/pkg/client/clientset/versioned"
	internalinterfaces "github.com/yaamai/mutation/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/yaamai/mutation/pkg/client/listers/myresource/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TrstringerV1().MyResources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrstringerV1().MyResources(namespace).Watch(context.TODO(), options)
			},
		},
